...
class EasyRecipePlusMicrodata {
    ...
    public function __construct($content) {
        ...
        $dom->registerNodeClass('DOMDocument', 'EasyRecipePlusDOMDocument');
        $dom->registerNodeClass('DOMElement', 'EasyRecipePlusMicrodataDOMElement');
    ...
    /**
     * Returns the EasyRecipePlusDOMDocument
     *
     * @return EasyRecipePlusDOMDocument
     */
 ...
 */
class EasyRecipePlusMicrodataDOMElement extends DOMElement {
     ...
     *
     * @return An array of itemtype tokens.
     */
     ...
     *
     * @return An array of EasyRecipePlusDOMElements which are properties of this
     *         element.
     */
