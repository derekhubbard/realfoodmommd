...
class EasyRecipePlusConvert {
    ...
    function convertHTML($postID, $plugin = '') {
        ...
        $data->photoURL = $result->recipe_image;

        $data->cuisine = $result->cuisine;
        $data->type = $result->mealType;
        ...
        $data->yield = $result->yield;
        $data->summary = $result->summary;
        $data->servesize = $result->serving_size;
        $data->notes = preg_replace('/\r?\n/i', '[br]', $result->notes);

        if (isset($result->nutrition)) {
            $nutrition = $result->nutrition;
            $data->calories = $nutrition->calories;
            $data->fat = $nutrition->totalFat;
            $data->satfat = $nutrition->saturatedFat;
            $data->transfat = $nutrition->transFat;
            $data->unsatfat = $nutrition->unsaturatedFat;
            $data->cholesterol = $nutrition->cholesterol;
            $data->sodium = $nutrition->sodium;
            $data->carbs = $nutrition->totalCarbohydrates;
            $data->fiber = $nutrition->dietaryFiber;
            $data->sugar = $nutrition->sugars;
