...
class EasyRecipePlus {
    ...
    private $pluginVersion = '3.2.2708';
    ...
    const GOOGLESNIPPETURL = 'http://www.google.com/webmasters/tools/richsnippets?url=%s';
    ...
    function initialiseAdmin() {
         ...
         */
        $autoUpdate = new EasyRecipePlusAutoUpdate($this->pluginVersion, self::VERSIONCHECKURL, $this->settings->licenseKey);
     ...
     */
    function initialise() {
        wp_register_style("easyrecipe-UI", self::$EasyRecipePlusURL . "/ui/easyrecipeUI{$this->uiVersion}.css", array('wp-admin', 'wp-pointer'), $this->pluginVersion);
    ...
    function loadSettingsPage() {
        ...
        wp_enqueue_style("easyrecipe-settings", self::$EasyRecipePlusURL . "/css/easyrecipe-settings.css", array('easyrecipe-UI'), $this->pluginVersion);
        wp_enqueue_style("thickbox");
        wp_enqueue_script('thickbox');
        wp_enqueue_script('easyrecipe-settings', self::$EasyRecipePlusURL . "/js/easyrecipe-settings.js", array('jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-autocomplete', 'jquery-ui-tabs', 'jquery-ui-button', 'thickbox'), $this->pluginVersion, true);

        wp_enqueue_style("easyrecipe-plupload", self::$EasyRecipePlusURL . "/plupload/css/jquery.ui.plupload{$this->pluploadVersion}.css", array('easyrecipe-UI'), $this->pluginVersion);
        if ($this->wpVersion == '-3.9') {
            wp_enqueue_script('easyrecipe-plupload', self::$EasyRecipePlusURL . "/plupload/jquery.ui.plupload{$this->pluploadVersion}.js", array('plupload-all', 'jquery-ui-progressbar', 'jquery-ui-button', 'jquery-ui-sortable'), $this->pluginVersion, true);
        } else {
            ...
            wp_enqueue_script('easyrecipe-plupload', self::$EasyRecipePlusURL . "/plupload/jquery.ui.plupload{$this->pluploadVersion}.js", array('plupload-html4', 'jquery-ui-progressbar', 'jquery-ui-button', 'jquery-ui-sortable'), $this->pluginVersion, true);
        }
        wp_enqueue_script('easyrecipe-import', self::$EasyRecipePlusURL . "/js/easyrecipe-import.js", array('easyrecipe-plupload', 'easyrecipe-settings'), $this->pluginVersion, true);
    ...
    function loadPostAdmin() {
        ...
        if (empty($_REQUEST['post_type']) || $_REQUEST['post_type'] != 'soliloquy' || $_REQUEST['post_type'] != 'easyindex') {
            ...
            wp_enqueue_style("easyrecipe-UI");
            wp_enqueue_style("easyrecipe-entry", self::$EasyRecipePlusURL . "/css/easyrecipe-entry.css", array('easyrecipe-UI'), $this->pluginVersion);

            wp_enqueue_script('jquery-ui-dialog');
            wp_enqueue_script('jquery-ui-autocomplete');
            wp_enqueue_script('jquery-ui-button');
            wp_enqueue_script('jquery-ui-tabs');
            wp_enqueue_script('easyrecipe-entry', self::$EasyRecipePlusURL . "/js/easyrecipe-entry{$this->wpVersion}.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button',
    ...
    function enqueAdminScripts($hook) {
        if ($hook == 'edit.php' && $this->settings->gpUserID != 0) {
            ...
            wp_enqueue_style("easyrecipe-posts", self::$EasyRecipePlusURL . "/css/easyrecipe-posts.css", array('easyrecipe-UI'), $this->pluginVersion);
            wp_enqueue_script('easyrecipe-posts', self::$EasyRecipePlusURL . "/js/easyrecipe-posts.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button',
                    'jquery-ui-tabs'), $this->pluginVersion, true);
        }
    }
    ...
    function enqueueScripts() {
        ...
        */
        ...
        wp_enqueue_style('easyrecipestyle-reset', self::$EasyRecipePlusURL . "/css/easyrecipe-style-reset.css", array(), $this->pluginVersion);
        wp_enqueue_style("easyrecipebuttonUI", self::$EasyRecipePlusURL . "/ui/easyrecipe-buttonUI.css", array('easyrecipestyle-reset'), $this->pluginVersion);
        /**
        ...
        if ($this->styleData->directory[0] == '_') {
            ...
            wp_enqueue_style("easyrecipestyle", self::$EasyRecipePlusURL . "/styles/$this->styleName/style.css", array('easyrecipestyle-reset'), "$this->pluginVersion.{$this->styleData->version}");
        }

        if (file_exists(self::$EasyRecipePlusDir . "/styles/$this->styleName/style.js")) {
            wp_enqueue_script('easyrecipestyle', self::$EasyRecipePlusURL . "/styles/$this->styleName/style.js", array($this->pluginName), "$this->pluginVersion.{$this->styleData->version}", $this->loadJSInFooter);
        }

        wp_enqueue_script($this->pluginName, self::$EasyRecipePlusURL . "/js/easyrecipe.js", array('jquery', 'jquery-ui-button'), $this->pluginVersion, $this->loadJSInFooter);
        ...
        if (current_user_can("edit_theme_options")) {
            ...
            */
            wp_enqueue_style("easyrecipe-FormatUI", self::$EasyRecipePlusURL . "/formatui/easyrecipeFormatUI{$this->uiVersion}.css", array(), $this->pluginVersion);
            wp_enqueue_style("easyrecipeformat", self::$EasyRecipePlusURL . "/css/easyrecipe-format.css", array('easyrecipe-FormatUI'), $this->pluginVersion);

            wp_enqueue_script('easyrecipeformat', self::$EasyRecipePlusURL . "/js/easyrecipe-format.js", array('jquery', 'jquery-ui-slider', 'jquery-ui-autocomplete', 'jquery-ui-accordion',
    ...
    function addMetaBoxes() {
        add_meta_box('easyrecipe-snippet', 'Google Rich Snippet Preview  &nbsp; &nbsp; &nbsp; &nbsp; <a href="http://www.easyrecipeplugin.com/support/google-doesnt-show-rich-snippets-for-my-posts/" target="_blank">Not seeing what you expected?</a>', array($this, 'snippetViewMetaBox'), 'post', 'normal', 'high');
    }
    ...
    function enqueueFooderificWPPointer() {
        if (current_user_can('edit_theme_options')) {
            ...
            if (!in_array('easyrecipe-fooderific', $dismissed)) {
                ...
                wp_enqueue_script('easyrecipe-wppointer', self::$EasyRecipePlusURL . "/js/easyrecipe-wppointer.js", array('wp-pointer'), $this->pluginVersion);
...
//                    if (!$this->settings->gpUseGravity) {
                    wp_enqueue_style("easyrecipe-guestpost", self::$EasyRecipePlusURL . "/css/easyrecipe-guestpost.css", array(), $this->pluginVersion);
                    wp_enqueue_script('easyrecipe-guestpost', self::$EasyRecipePlusURL . "/js/easyrecipe-guestpostdetails.js", array('jquery'), $this->pluginVersion, true);
//                    }
                    break;
                ...
                case $this->settings->gpEntryPage:
                    wp_enqueue_style("easyrecipe-UI");
                    wp_enqueue_style("easyrecipe-entry", self::$EasyRecipePlusURL . "/css/easyrecipe-entry.css", array('easyrecipe-UI'), $this->pluginVersion);
                    wp_enqueue_style("easyrecipe-guestpost", self::$EasyRecipePlusURL . "/css/easyrecipe-guestpost.css", array('easyrecipe-entry'), $this->pluginVersion);
                    wp_enqueue_style("easyrecipe-guestposteditor", self::$EasyRecipePlusURL . "/css/easyrecipe-guestposteditor{$this->wpVersion}.css", array('easyrecipe-entry'), $this->pluginVersion);
                    wp_enqueue_script('plupload');
                    wp_enqueue_script('plupload-html5');
                    wp_enqueue_script('plupload-flash');
                    wp_enqueue_script('plupload-silverlight');
                    ...
                    wp_enqueue_script('easyrecipe-entry', self::$EasyRecipePlusURL . "/js/easyrecipe-entry{$this->wpVersion}.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button',
                            'jquery-ui-tabs'), $this->pluginVersion, true);
                    wp_enqueue_script('easyrecipe-guestpost', self::$EasyRecipePlusURL . "/js/easyrecipe-guestpostentry{$this->wpVersion}.js", array('plupload', 'easyrecipe-entry',
                            'jquery-ui-progressbar'), $this->pluginVersion, true);
...
EOD;
        ...
        */
        if ($isPrint && current_user_can("edit_theme_options")) {
            $html .= sprintf('<script type="text/javascript" src="%s/js/easyrecipe-format.js?version=%s"></script>', self::$EasyRecipePlusURL, $this->pluginVersion);
        }
        return $html;
    }
    ...
    */
    private function printRecipe($postID, $recipeIX) {
        ...
        /**
         * Process Ziplist recipes if required
         */
...
//        $this->printStyleData = call_user_func(array($this->stylesClass, 'getStyleData'), $this->styleName, $this->settings->get('customTemplates'), true);
     ...
     * Otherwise, Genesis may just arbitraily truncate the content and leave open HTML block elements - this will usually totally stuff up the layout
     *
     * @param Object $post
     */
...
EOD;
    ...
    function mcePlugins($plugins) {
        ...
        $plugins['easyrecipe'] = self::$EasyRecipePlusURL . "/js/easyrecipe-mce{$this->mceVersion}.js?v=$this->pluginVersion";
        $plugins['noneditable'] = self::$EasyRecipePlusURL . "/tinymce/noneditable{$this->mceVersion}.js?v=$this->pluginVersion";
        if ($this->isGuest) {
            $plugins['guestpost'] = self::$EasyRecipePlusURL . "/js/easyrecipe-guestpost-mce{$this->mceVersion}.js?v=$this->pluginVersion";
        }
        return $plugins;
    }
