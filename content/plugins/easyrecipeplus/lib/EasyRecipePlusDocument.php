...
class EasyRecipePlusDocument extends EasyRecipePlusDOMDocument {
    ...
    function setSettings(EasyRecipePlusSettings $settings) {
     ...
     * @return string
     */
    function applyStyle(EasyRecipePlusTemplate $template, $originalData, $recipe = null) {
        $nRecipe = 0;
